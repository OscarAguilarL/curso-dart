...
List<RestCountryRespuesta> restCountryRespuestaFromJson(String str) =>
    List<RestCountryRespuesta>.from(
        json.decode(str).map((x) => RestCountryRespuesta.fromJson(x)));

String restCountryRespuestaToJson(List<RestCountryRespuesta> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RestCountryRespuesta {
  RestCountryRespuesta({
    required this.name,
    required this.tld,
    required this.cca2,
    required this.ccn3,
  ...
  factory RestCountryRespuesta.fromJson(Map<String, dynamic> json) =>
      RestCountryRespuesta(
